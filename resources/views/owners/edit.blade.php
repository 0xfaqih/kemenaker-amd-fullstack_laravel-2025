...
@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-900">Edit Pemilik</h1>
</div>
    ...
    <form action="{{ route('owners.update', $owner->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <textarea name="address" id="address" rows="3" 
                      class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('address', $owner->address) }}</textarea>
        </div>

        <div class="mb-4">
            <label class="flex items-center">
                <input type="checkbox" name="phone_verified" value="1" {{ old('phone_verified', $owner->phone_verified) ? 'checked' : '' }}
